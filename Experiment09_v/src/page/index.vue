    ...
    <section class="project_section">
        ...
        <el-row style="margin-top: 20px; display: flex; flex-direction:column;">
            <el-row style="display: flex;justify-content: flex-end;">
                <el-button style="margin: 15px; width: 100px;" type="danger" @click="handleAdd">添加用户</el-button>
            </el-row>
            <el-form ref="formData" class="demo-formData" label-width="110px">
                <el-table :data="tableData" border highlight-current-row>
                    <el-table-column type="index" width="100px"></el-table-column>
                    <el-table-column label="学号" property="id"></el-table-column>
                    ...
                    <el-table-column label="身份证号" property="identityCard"></el-table-column>
                    <el-table-column label="操作" width="240px">
                        <template v-slot="scope">
                            <el-button size="small" style="width: 100px" type="primary"
                                       @click="handleDetails(scope.$index)">查看详情
                            </el-button>
                            <el-button size="small" style="width: 100px" type="danger"
                ...
                <div class="Pagination" style="text-align: left;margin-top: 10px;">
                    <el-pagination :current-page="pageForm.pageNum" :page-size="pageForm.pageSize"
...
<script>
import {deleteUser, getAllUser} from "@/api/getData";
    ...
    methods: {
        async loadUserInfo() {
            const res = await getAllUser({
                pageNum: this.pageForm.pageNum, pageSize:
        ...
        async handleDelete(index) {
            const res = await deleteUser({id: this.tableData[index].id, accountId: this.$store.state.userInfo.accountId, token: this.$store.state.userInfo.token})
            if (res.status === 1) {
                await this.loadUserInfo()
            } else {
                this.$message({

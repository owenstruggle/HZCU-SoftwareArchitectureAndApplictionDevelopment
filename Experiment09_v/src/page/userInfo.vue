        ...
        <el-row style="margin-top: 20px;">
            <el-col :span="12" :offset="4">
                <el-form :model="formData" :rules="rules" ref="formData" label-width="110px" class="demo-formData">
                    ...
                    <el-form-item>
                        <el-button size="small" type="primary" @click="handleUpdate()" style="width: 100px">更新
                        </el-button>
                    </el-form-item>
                </el-form>
            </el-col>
...
export default {
    ...
    methods: {
        async getUserInfo() {
            const res = await getUser({id: this.formData.id, accountId: this.$store.state.userInfo.accountId, token: this.$store.state.userInfo.token})
